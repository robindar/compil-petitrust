...
type typed_expr =
  ...
  | TFunCall of ident * typed_expr list * location * expr_type
  | TVec of typed_expr list * location * expr_type
  | TPrint of _string * location * expr_type
  | TBloc of typed_bloc * location * expr_type
and typed_decl =
  | TDeclStruct of ident * (ident * expr_type) list * location * expr_type
  | TDeclFun of ident * (bool * ident * expr_type) list * expr_type * typed_bloc * location * expr_type
...
and typed_instr =
  ...
  | TLet of bool * ident * typed_expr * location * expr_type
  | TLetStruct of bool * ident * ident * (ident * typed_expr) list * location * expr_type
